...
const contractABI = require("../artifacts/contracts/Contractworkshop.sol/Contractworkshop.json").abi;

program
    .name("contractworkshop-cli")
    .description("CLI tool for Contractworkshop smart contract")
    .version("1.0.0");
